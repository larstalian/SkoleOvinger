...
public class Client {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "This program shows your person and employment information. "
    ...
    System.out.println(
        "Name: "
            ...
            + employee.getAge()
            + "\nEmployment number: "
            + employee.getEmploymentNumber()
            + "\nEmployed since: "
            + employee.getEmploymentYear()
            + "\nMonthly gross salary: "
            + employee.getMonthlyGross()
            + "kr"
            + "\nYearly gross salary: "
    ...
    while (run) {
      ...
      switch (choice) {
        ...
        case 2 -> {
          ...
          System.out.println(
              "Your new monthly gross is "
                  + employee.getMonthlyGross()
                  + "kr"
                  + "\nYour new yearly gross salary is: "
                  + employee.getGrossSalary()
                  + "kr"
                  + "\nYour new yearly tax is: "
                  + employee.getTaxPerYear()
                  + "kr");
        }
        case 3 -> {
          ...
          System.out.println(
              "Your employment year is now "
                  + employee.getEmploymentYear()
                  + " and you have been employed for "
                  + employee.getYearsOfEmployment()
                  + " years");
        }
        case 4 -> {
          System.out.println(
              "Check if you have been employed more than x years. Please enter x in years");
          int input = in.nextInt();
          System.out.println(
              "You have been employed for more than "
                  + input
                  + " years: "
                  + employee.getEmployedForXYearsBool(input));
        }
        case 5 -> {

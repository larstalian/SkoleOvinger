...
public record NewString(String text) {
  ...
  /**
   * Removes the character in lower case and in upper case from the text. Transforms the String to a
   * String array to fit the print method.
   *
  ...
  public String[] getTextWithRemovedCharacter(String inputRemoveCharacter) {
    ...
    return new String[] {
      text()
          .replace(inputRemoveCharacter.toLowerCase(), "")

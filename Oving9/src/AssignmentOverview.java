...
public class AssignmentOverview {
    ...
    /**
     * The AssignmentOverview constructor.
     * Creates a new arraylist students.
     */
    ...
    public static void client() {
        ...
        System.out.println("This program lets you register new students "
                + "and track their approved assignments");
    ...
    public String toString() {
        ...
        for (int i = 0; i < getNumberOfStudents(); i++) {
            s.append(students.get(i).getName()).append(". Approved assignments: ")
                    .append(students.get(i).getNumberOfApprovedAssignments()).append(" | ");
        }
        return s.toString();
    }
